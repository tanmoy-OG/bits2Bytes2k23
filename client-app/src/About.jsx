export const About = () => {
  return (
    <div className="flex flex-col px-4 md:pl-20 md:pr-20" id="about">
      ...
      <h1
        className="p-4 md:p-10 pb-5 text-4xl md:text-5xl font-bold tracking-wider text-neutral-200"
        data-aos="fade-up"
      >
        ABOUT BITS2BYTES
      </h1>
      <p
        className="pb-4 md:pb-10 pl-4 md:pl-20 pr-4 md:pr-20 text-base md:text-2xl leading-8 md:leading-10 text-left text-neutral-300 font-custom"
        data-aos="fade-right"
        data-aos-delay="1000"
      >
