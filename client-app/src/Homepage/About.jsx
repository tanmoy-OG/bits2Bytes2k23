export const About = () => {
  return (
    <div className="flex flex-col px-4 md:pl-20 md:pr-20 bg-blue-500/10 backdrop-blur-lg overflow-hidden ml-6 mr-6 mb-10" id="about">
      <h1
      ...
      <p
        className="pb-4 md:pb-10 pl-4 md:pl-20 pr-4 md:pr-20 text-base md:text-2xl leading-8 md:leading-10 text-left text-neutral-300 font-custom-sans" data-aos="fade-right"
      >
